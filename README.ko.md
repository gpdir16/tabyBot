...
- **할 일 목록**: 에이전트가 볼 수 있는 할 일 목록을 관리합니다. 봇이 추가·수정·삭제를 제안하면 사용자가 승인하며, 할 일을 봇에게 넘겨 대신 수행하게 할 수도 있습니다 — 수행 가능한 봇이 자원하면 사용자가 골라 위임하고, 봇이 예약된 시간이나 즉시 실행합니다. 넘기지 않은 할 일은 마감 시 알림을 보냅니다.
