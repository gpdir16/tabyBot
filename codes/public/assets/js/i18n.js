...
(function (T) {
    ...
    const DICT = {
        en: {
            ...
            setupTitle: "Set up tabyBot",
            setupSubtitle: "A few steps and you’re ready.",
            setupLanguage: "Choose language",
            setupProvider: "Choose provider",
            setupApiKey: "Authentication",
            setupApiKeyHint: "Your key is stored locally and never leaves this machine.",
            setupModel: "Pick a model",
            setupDoneTitle: "You’re all set",
            setupDone: "tabyBot is ready to use.",
            next: "Continue",
            back: "Back",
            start: "Start chatting",
            tokenTitle: "Access token",
            tokenDesc: "This server requires an access token.",
            tokenSubmit: "Connect",
            tokenFailed: "Connection failed. Check the token.",
            connected: "Connected",
        ...
        ko: {
            ...
            setupTitle: "tabyBot 설정",
            setupSubtitle: "몇 단계만 거치면 바로 사용할 수 있어요.",
            setupLanguage: "언어 선택",
            setupProvider: "프로바이더 선택",
            setupApiKey: "인증",
            setupApiKeyHint: "키는 이 컴퓨터에만 저장되고 외부로 나가지 않습니다.",
            setupModel: "모델 선택",
            setupDoneTitle: "준비 완료",
            setupDone: "tabyBot 사용 준비 완료",
            next: "계속",
            send: "전송",
            back: "뒤로",
            start: "대화 시작",
            tokenTitle: "액세스 토큰",
            tokenDesc: "이 서버는 액세스 토큰이 필요합니다.",
            tokenSubmit: "연결",
            tokenFailed: "연결에 실패했습니다. 토큰을 확인하세요.",
            connected: "연결됨",
        ...
        ja: {
            ...
            setupTitle: "tabyBotをセットアップ",
            setupSubtitle: "いくつかのステップで使えるようになります。",
            setupLanguage: "言語を選択",
            setupProvider: "プロバイダを選択",
            setupApiKey: "認証",
            setupApiKeyHint: "キーはこのマシンにのみ保存され、外部には送信されません。",
            setupModel: "モデルを選択",
            setupDoneTitle: "準備完了",
            setupDone: "tabyBotを使う準備ができました",
            next: "続ける",
            back: "戻る",
            start: "会話を始める",
            tokenTitle: "アクセストークン",
            tokenDesc: "このサーバーはアクセストークンが必要です。",
            tokenSubmit: "接続",
            tokenFailed: "接続に失敗しました。トークンを確認してください。",
            connected: "接続済み",
            connectingState: "接続中…",
