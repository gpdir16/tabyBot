...
export function buildFilesystemPromptBlock() {
    ...
    const lines = [
        ...
        `| Path | Role |`,
        `|------|------|`,
        `| \`${USER_DIR}\` | **Main home (default).** Configuration, memory, skills, MCP, scheduling, chat temp, and **most work**. Default \`terminal_run\` cwd. Relative \`file_*\` paths resolve here. |`,
